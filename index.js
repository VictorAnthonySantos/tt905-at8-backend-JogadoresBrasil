...
/*
Daqui pra baixo banco de dados MongoDB
*/

const mongodb = require('mongodb')
const password = process.env.PASSWORD || "h05wHQ7mWxDtszDb";
console.log(password);

const connectionString = `mongodb+srv://victor:${password}@cluster0.vtfhu.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
