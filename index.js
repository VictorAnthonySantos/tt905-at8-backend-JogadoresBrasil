...
const password = process.env.PASSWORD || "Zgvj52aAH9swFrPw";
console.log(password);

const connectionString = `mongodb+srv://admin:${"Zgvj52aAH9swFrPw"}@cluster0.sy1ep.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
